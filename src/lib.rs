...
mod contract {
    ...
    pub extern "C" fn submit() {
        ...
        Engine::check_nonce(&sender, &transaction.nonce).sdk_unwrap();
        ...
        // };
        Engine::refund_unused_gas(&sender, gas_limit, prepaid_amount, &relayer).sdk_unwrap();
